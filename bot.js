...
client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === '-') {
              message.channel.send('**#Welcome To Gang Community...:tada::tada:**');
...
member.addRole(member.guild.roles.find('name', 'GANG'));
});
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`---------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setGame(`Gang Community`,"http://twitch.tv/y04zgamer")
